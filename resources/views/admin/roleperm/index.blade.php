				...
				<div class="conShow" id="vue">
					<table border="1" cellspacing="0" cellpadding="0">
                        ...
                        <tr >
                            ...
                            <td>
                                <a href="{{url('admin/role_perm_edit')}}?id={{$v->rp_id}}"><img class="operation" src="/style/admin/img/update.png"></a> 
                                <a href="javascript:;"><img id="del"  rp_id="{{$v->rp_id}}" class="operation delban"src="/style/admin/img/delete.png"></a>    
                            </td>                        
                        </tr>
                        @endforeach
                    </table>
...
<script>
    $(document).on('click','#del',function(){
        ...
        $.post(
            "{{url('admin/role_perm_del')}}",
            {id:id},
            function(res){
                if(res==0){
                    var url = "{{url('/admin/role_perm_index')}}"
                    location.href=url
                }
            }
        ),'json'
